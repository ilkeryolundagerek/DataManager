...
public partial class AW22Context : DbContext
{
    public AW22Context()
    {
        //Scaffold-DbContext "server=localhost;database=AdventureWorks2022;user id=sa;password=1;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -Context AW22Context -ContextDir Data.Contexts -OutputDir Core.Concretes.Entities
    }

    public AW22Context(DbContextOptions<AW22Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=localhost;database=AdventureWorks2022;user id=sa;password=1;TrustServerCertificate=True;");
